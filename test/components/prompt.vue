<template>
	<view class="prompt-box" :hidden="isHidden">
		<view class="prompt-content contentFontColor">
			...
			<input class="prompt-input" type="text" v-model="cost"/>
			<view class="prompt-text">{{textname}}</view>
			<input class="prompt-input" type="text" v-model="t"/>
	...
	export default {
		...
		methods: {
			...
			_confirm () {
			  ...
			  this.$emit('onConfirm', this.cost,this.t);
			},
			_input(e){
